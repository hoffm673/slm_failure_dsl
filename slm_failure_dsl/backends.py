...
- StubModel: deterministic-ish, no real inference, useful for unit tests and CPU dev.
...
class StubModel:
    """Deterministic-ish stub for testing without a real model."""
...
class TransformersModel:
    """Real HuggingFace transformers backend. Imports lazily."""
    ...
    def generate(self, prompt: str, max_new_tokens: int = 256, temperature: float = 0.7) -> str:
        ...
        # use chat template if available; get string back then tokenize ourselves
        # for consistent behavior across transformers versions
...
# convenience: candidate small/large pairs for the eval
MODEL_PAIRS = {
